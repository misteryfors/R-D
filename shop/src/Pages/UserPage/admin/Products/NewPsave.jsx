...
files.forEach(file => dispatch(uploadFile(file,'', UID)))
}
...
<Input value={name} setValue={setName} type="text" placeholder="Введите название..."/>
            ...
            <button onClick={() => dispatch(createProduct(name, type, mark, img, price, shortDescription, description, false))}>Создать</button>
